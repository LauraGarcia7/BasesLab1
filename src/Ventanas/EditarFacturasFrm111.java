 ...
 * @author Sulay2016
 */
public class EditarFacturasFrm111 extends JApplet {
    ...
    public static void ShowFrame() {
        ...
        JApplet applet = new EditarFacturasFrm111();
        applet.init();
    ...
    private void createScene() {
        ...
        btn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                usuario.perfil = comboPerfil.getValue() == "Guardar" ? 1: 2;

                if (GuardarUsuario(usuario)) {
                    EditarFacturasFrm111.frame.setVisible(false);
                }
            }
        });
