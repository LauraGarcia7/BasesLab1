 ...
 * @author Sulay2016
 */
public class EliminarFacturasFrm1111 extends JApplet {
    ...
    public static void ShowFrame() {
        frame = new JFrame("Eliminar Factura");
        frame.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);

        JApplet applet = new EliminarFacturasFrm1111();
        applet.init();
    ...
    private void createScene() {
        ...
        btn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                usuario.perfil = comboPerfil.getValue() == "Eliminar" ? 1: 2;

                if (GuardarUsuario(usuario)) {
                    EliminarFacturasFrm1111.frame.setVisible(false);
                }
            }
        });
