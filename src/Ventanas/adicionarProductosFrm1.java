 ...
 * @author Sulay2016
 */
public class adicionarProductosFrm1 extends JApplet {
    ...
    public static void ShowFrame() {
        frame = new JFrame("Adicionar Producto");
        frame.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);

        JApplet applet = new adicionarProductosFrm1();
        applet.init();
    ...
    private void createScene() {
        ...
        Label labelcantidad = new Label("Ingrese la cantidad:");
        Label labelFechaFabricacion = new Label("Ingrese FechaFabricacion:");
        Label labelFechaCaducidad = new Label("Ingrese FechaCaducidad:");
        Label labelProveedor = new Label("Ingrese el Proveedor:");
        Label labelPrecioUnitario = new Label("Ingrese PrecioUnitario:");
        ...
        btn.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (GuardarUsuario(usuario)) {
                    adicionarProductosFrm1.frame.setVisible(false);
                }
            }
        });
        ...
        root.getChildren().add(labelProveedor);
        GridPane.setConstraints(labelProveedor, 0, 4);

        root.getChildren().add(textProveedor);
        GridPane.setConstraints(textProveedor, 1, 4);

        root.getChildren().add(labelPrecioUnitario);
        GridPane.setConstraints(labelPrecioUnitario, 0, 5);

        root.getChildren().add(textPrecioUnitario);
        GridPane.setConstraints(textPrecioUnitario, 1, 5);
